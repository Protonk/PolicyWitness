...
func runCWorkerTests(_ tk: TestKit) {
    tk.group("CWorker driver") {
        ...
        // Environment/descriptor isolation is observed inside exec children by
        // tests/suites/runner_exec_inheritance. Its controlled worker launch
        // proves that resources existed to leak; empty output cannot pass it.
