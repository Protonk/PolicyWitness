...
PW_TEST_SUITE="runner_apply_isolation_v3"
PW_TEST_ID="deny_default_v3_worker_reply"

PW_BIN="${PW_BIN:-${PW_APP_DIR}/Contents/MacOS/policy-witness}"

test_begin "${PW_TEST_SUITE}" "${PW_TEST_ID}"
test_step "run" "run v3 deny-default specimen through host/worker split"
...
test_pass "v3 deny-default worker replied through unsandboxed host" "{}"
