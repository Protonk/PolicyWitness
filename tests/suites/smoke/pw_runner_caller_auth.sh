...
CLIENT_BIN="${ROOT_DIR}/PolicyWitness.app/Contents/MacOS/pw-runner-client"
REQUEST_JSON="${ROOT_DIR}/tests/fixtures/pw_runner/specimen_file_read_deny.json"
RUNNER_STD_BUNDLE="${ROOT_DIR}/PolicyWitness.app/Contents/XPCServices/PWRunner.xpc"
RUNNER_DBG_BUNDLE="${ROOT_DIR}/PolicyWitness.app/Contents/XPCServices/PWRunnerDebug.xpc"
